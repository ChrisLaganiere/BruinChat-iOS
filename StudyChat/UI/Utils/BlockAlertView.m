...
- (void) setClickedButtonBlock:(JLAlertBlock)clickedButtonBlock { _clickedButtonBlock = clickedButtonBlock; }
- (void) setWillDismissBlock:(JLAlertBlock)willDismissBlock     { _willDismissBlock = willDismissBlock; }
- (void) setDidDismissBlock:(JLAlertBlock)didDismissBlock       { _didDismissBlock = didDismissBlock; }
